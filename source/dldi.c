...
-----------------------------------------------------------------*/
bool ED_DLDI__clearStatus (void) {
	return true;
}
...
-----------------------------------------------------------------*/
bool ED_DLDI__readSectors (u32 sector, u32 numSectors, void* buffer) {
	u8* data = (u8*)buffer;
...
return true if it was successful, false if it failed for any reason
-----------------------------------------------------------------*/
bool ED_DLDI__writeSectors (u32 sector, u32 numSectors, void* buffer) {
	u8* data = (u8*)buffer;
